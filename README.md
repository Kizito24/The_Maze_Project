...
```
git clone https://github.com/Kizito24/The_Maze_Project.git
...
[`headers`](https://github.com/Kizito24/The_Maze_Project/tree/master/headers)

All the header files are in here.

[`images`](https://github.com/Kizito24/The_Maze_Project/tree/master/images)

This contains all image files.

[`maps`](https://github.com/Kizito24/The_Maze_Project/tree/master/maps)

This will be used by the program to output the map layout using the data map files

[`src`](https://github.com/Kizito24/The_Maze_Project/tree/master/src)

All the source code files written in C  are in this folder.

[`tests`](https://github.com/Kizito24/The_Maze_Project/tree/master/tests)
...
- Duplicate the repository and establish a new branch using the following command: __$ git checkout https://github.com/Kizito24/The_Maze_Project -b [name_of_new_branch]__.
...
- __Chiazor Kizito__ - [Github](https://github.com/Kizito24)/ [Contact Me](mailto:kizitochiazor@gmail.com) 
